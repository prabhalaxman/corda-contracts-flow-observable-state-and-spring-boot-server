...
public class UpdateFlow {
    ...
    @InitiatingFlow
    @StartableByRPC
    public static class UpdateInitiator extends FlowLogic<SignedTransaction> {
      ...
      //  private final Party otherOrg;
        ...
        public UpdateInitiator(String customerId,
                               String name,
                               String address,
                               String acNo,
                               String idType,
        ...
        public SignedTransaction call() throws FlowException {
            ...
            UniqueIdentifier linearid = new UniqueIdentifier(customerId, UUID.fromString(uuid));

            KYCState iouState = null;
            //if (vendor != null) {
                iouState = new KYCState( bank, me, customerId, name, address, acNo, idType, idNumber, phone, email, linearid);
//            } else if (otherOrg != null) {
//                iouState = new KYCState(bank, null, me, customerId, name, address, acNo, idType, idNumber, phone, email, linearid);
//            }
...
//  KYCState iouState = new KYCState(iouValue, me, otherParty, new UniqueIdentifier(),userId);
            final Command<IOUContract.Commands.Create> txCommand = new Command<>(
                    ...
                    ImmutableList.of( iouState.getVendor().getOwningKey(),iouState.getBank().getOwningKey()));
...
//            return subFlow(new FinalityFlow(fullySignedTx, ImmutableSet.of(otherPartySession)));
    ...
    @InitiatedBy(UpdateInitiator.class)
