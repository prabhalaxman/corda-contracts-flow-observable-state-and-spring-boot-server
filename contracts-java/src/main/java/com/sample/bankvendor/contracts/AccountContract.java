package com.sample.bankvendor.contracts;
...
public class AccountContract implements Contract {
    public static final String ID = "com.sample.bankvendor.contracts.AccountContract";
    ...
    public void verify(LedgerTransaction tx) {
        ...
        requireThat(require -> {
            ...
            final AccountStatementState out = tx.outputsOfType(AccountStatementState.class).get(0);
            require.using("The Bank and the Vendor/Other Org cannot be the same entity.",
                    (out.getBank() != out.getAccount()));
            ...
            require.using("The IOU's Customer must be not null.",
                    out.getVendorId() != null);

            require.using("The IOU's Tx Id Number must not be null.",
                    out.getTxId() != null);
