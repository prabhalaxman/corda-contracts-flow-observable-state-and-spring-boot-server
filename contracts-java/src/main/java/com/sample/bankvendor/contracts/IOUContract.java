...
public class IOUContract implements Contract {
    public static final String ID = "com.sample.bankvendor.contracts.IOUContract";
    ...
    public void verify(LedgerTransaction tx) {
        ...
        requireThat(require -> {
            ...
            require.using("The IOU's Customer must be not null.",
                    out.getCustomerId() !=null);

            require.using("The IOU's Id Number must not be null.",
                    out.getIdNumber() !=null);
